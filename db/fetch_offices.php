...
$columns = array(
    ...
    array( 'db' => 'squarefeet', 'dt' => 3 ),
    array( 'db' => 'stage', 'dt' => 4 ),
    array( 'db' => 'mark', 'dt' => 5 ),
    array( 'db' => 'structure', 'dt' => 6 ),
    array( 'db' => 'main_image', 'dt' => 7 ),
    array( 'db' => 'other_images', 'dt' => 8 ),
    array( 'db' => 'is_completed', 'dt' => 9 )
); 
...
// Call SSP class for server-side processing and encoding to JSON
 ...
 foreach ($res['data'] as $data ) {
    ...
    $data[7]="<img height='50px' src='../".$data[7]."'/>" ; 
